        ...
        if (isset($_POST['emplogin'])) 
        {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    if (
                        ...
                        header('Refresh: 2; URL = EmpHome.php');
                        # mysqli_close($conn);  
                    } else {
              ...
              <div class="form-group col-md-5 text-center">
                ...
                <div class="form-group">
                  <div class="input-group col-md-5 text-center">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="Your Employee Email" required />
                    </div>
                </div>
                ...
                <div class="form-group col-md-5 text-center">
                  <button type="submit" class="btn btn-block btn-primary" name="emplogin">Log In</button>
                </div>                
                <div class="form-group col-md-5 text-center">
                  <hr />
                </div>                
